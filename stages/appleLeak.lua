...
function onCreate()   
    ...
    makeLuaSprite("wavyApplecoreBLACK", "", 0, 150)
    makeGraphic("wavyApplecoreBLACK", 2560, 1400, '000000')
    setProperty('wavyApplecoreBLACK.visible', false)
    addLuaSprite("wavyApplecoreBLACK", false)
