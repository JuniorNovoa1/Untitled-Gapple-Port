...
function onCreatePost()
	...
	setProperty('kadeEngineWatermark.visible', false)
	...
	if name == 'Change Character' then
		...
		if value2 == '3d-bambi-leak-finale' then
			if loopVarThing == false then
				...
				setProperty('kadeEngineWatermark.visible', true)
				if not lowQuality then setProperty("healthBarBGnew.visible", true) end
